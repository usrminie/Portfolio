  ...
  return (
    <section id="about" className="relative py-16 bg-gradient-to-r from-gray-100 to-gray-300 dark:from-gray-800 dark:to-gray-900">
      ...
      <div className="flex flex-col items-center justify-center p-8 select-none">
        ...
        <div className="flex flex-col md:flex-row md:items-start max-w-5xl mx-auto relative z-10">
          ...
          <div className="md:w-1/2 text-lg md:text-lg text-gray-700 dark:text-gray-300 leading-relaxed text-center mt-12">
